...
import { LayoutDashboard, Users, User, LogOut, GraduationCap, MessageSquare } from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-slate-900 text-gray-900 dark:text-white flex flex-col shadow-lg z-50 border-r border-gray-200 dark:border-slate-800 transition-colors duration-200">
